...
import type { Affiliate as _Affiliate, AppSettings as _AppSettings, ExternalBlob as _ExternalBlob, GenerationParams as _GenerationParams, Product as _Product, ProductInput as _ProductInput, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrUpdateAffiliate(arg0: Affiliate): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateAffiliate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addOrUpdateProduct(arg0: ProductInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateProduct(await to_candid_ProductInput_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteAffiliate(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteAffiliate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchUrl(arg0: string): Promise<HttpResult> {
        if (this.processError) {
            try {
    ...
    async generateContent(arg0: GenerationParams): Promise<ProductContent> {
        if (this.processError) {
            try {
                const result = await this.actor.generateContent(await to_candid_GenerationParams_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAffiliate(arg0: bigint): Promise<Affiliate | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAffiliate(arg0);
    ...
    async getAffiliates(): Promise<Array<Affiliate>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAffiliates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Affiliate]): Affiliate | null {
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AppSettings]): AppSettings | null {
    return value.length === 0 ? null : value[0];
}
...
async function to_candid_GenerationParams_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: GenerationParams): Promise<_GenerationParams> {
