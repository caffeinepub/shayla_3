...
import { Link2, Loader2, AlertCircle, CheckCircle2, Info, Trash2, ArrowRight, History } from 'lucide-react';
...
import { useGetHistory, useAddHistoryEntry } from '../hooks/useQueries';
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              ...
              <span>تاریخچه</span>
              {history.length > 0 && (
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gold text-background text-[10px] font-bold">
